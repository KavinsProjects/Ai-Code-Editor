    ...
    <Sidebar variant="inset" collapsible="icon" className="border-1 border-r">
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton isActive={pathname === "/"} tooltip="Home" onClick={() => router.push("/")}>
                  <Home className="h-4 w-4" />
                  <span>Home</span>
              </SidebarMenuButton>
            </SidebarMenuItem>
            <SidebarMenuItem>
              <SidebarMenuButton isActive={pathname === "/dashboard"} tooltip="Dashboard" onClick={() => router.push("/dashboard")}>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="View all" onClick={() => router.push("/playgrounds")}>
